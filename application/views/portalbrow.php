...
<body>
    ...
    <div id="container" class="boxed-page">
                ...
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="index.html" style="color:#000">
                            <img alt="" src="<?php echo base_url('assets_bs/images/log_pp3.png')?>"> PT PELINDO III PERSERO
                        </a>
                    </div>
                    <div class="navbar-collapse collapse">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li><a data-toggle="modal" data-target="#modallogin" href="#modallogin"><i class="fa fa-key"></i> Login </a>
                            </li>
                        </ul>
                        <!-- End Navigation List -->
                    </div>
            ...
            <div id="main-slide" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="item active">
                        <img class="img-responsive" src="<?php echo base_url('assets_bs/images/slider/'.$key['GAMBAR'].'')?>" alt="slider">
                ...
                <!--
                    <div class="item">
                        <img class="img-responsive" src="<?php echo base_url('assets_bs/images/slider/2 fix.jpg')?>" alt="slider">
                        <div class="slider-content">
                            <div class="col-md-12 text-center">
                                <h2 class="animated7">
                                <span>Masih <strong>Beranikah</strong> anda</span>
                            </h2>
                                <h3 class="animated8">
                                <span>Untuk menerimanya?</span>
                            </h3>   
                    ...
                    <!--
                    <div class="item">
                        <img class="img-responsive" src="<?php echo base_url('assets_bs/images/slider/3.jpg')?>" alt="slider">
                        <div class="slider-content">
                            <div class="col-md-12 text-center">
        ...
        <script type="text/javascript">
            this.name="opener";
            function wpopup(id){
                window.open("insert_berita.php","popup","toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, navigation=no, width=300, height=150",
    true).focus();
            }
        </script>
        -->
        ...
        <div class="section" style="background:#fff;">
            <div class="container">
                    ...
                    <!-- Start Big Heading -->
                    <center><H1><strong>E-GRATIFIKASI</strong></H1></center>
                    ...
                    <div class="row">
                        ...
                        <?php
                            ...
                            echo 'Tidak ada data untuk di tampilkan.';
                        }
                        ?>
                        <!-- Start Memebr 2 -->
                        <!--<div class="col-md-3 col-sm-6 col-xs-12" data-animation="fadeIn" data-animation-delay="04">
                            <div class="team-member modern">
                                <!-- Memebr Photo, Name & Position -->
                                <!--<div class="member-photo">
                                    <img alt="" src="<?php echo base_url('assets_bs/images/team/grat2.png')?>" />
                                    <div class="member-name">Komitmen GCG <span></span>
                                    </div>
                                </div>
                                <!-- Memebr Words -->
                            <!--    
                       ...
                       <!-- <div class="col-md-3 col-sm-6 col-xs-12" data-animation="fadeIn" data-animation-delay="05">
                            <div class="team-member modern">
                                <!-- Memebr Photo, Name & Position -->
                                <!--<div class="member-photo">
                                    <img alt="" src="<?php echo base_url('assets_bs/images/team/alur_grat.png')?>" />
                                    <div class="member-name">Alur E-Gratifikasi <span></span>
                                    </div>
                                </div>
                                <!-- Memebr Words -->
                              <!-- 
                        ...
                        <!--<div class="col-md-3 col-sm-6 col-xs-12" data-animation="fadeIn" data-animation-delay="06">
                            <div class="team-member modern">
                                <!-- Memebr Photo, Name & Position -->
                                <!--<div class="member-photo">
                                    <img alt="" src="<?php echo base_url('assets_bs/images/team/no.jpg')?>" />
                                    <div class="member-name">Say No <span></span>
                                    </div>
                                </div>
                                <!-- Memebr Words -->
                              <!--  
