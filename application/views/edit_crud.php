...
<form action="<?=base_url()?>index.php/c_crud/update" method="post" role="form">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <input type="text" name="pass" class="form-control" id="" value="<?=$user['PASSWORD']?>">
            </div>
            <div class="form-group">
              <label for="">STATUS</label>
              <input type="text" name="status" class="form-control" id="" value="<?=$user['STATUS']?>">
            </div>
