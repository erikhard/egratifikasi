...
<form action="<?=base_url()?>index.php/c_portalslide/insert_slide" method="post" role="form" enctype="multipart/form-data">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <div class="form-group">
              <label for=""></label>
              <input type="file" name="upload" class="form-control" id="" placeholder="Input Gambar">
            </div>
            <div class="form-group">
