...
function docReady(){
	...
	$('ul.gallery li').hover(function(){
		...
		$(this).append('<div class="well gallery-controls">'+
							'<p><a href="#" class="gallery-edit btn"><i class="icon-zoom-in"></i></a> <a href="#" class="gallery-delete btn"><i class="icon-remove"></i></a></p>'+
						'</div>');
		...
		"fnInit": function( oSettings, nPaging, fnDraw ) {
			...
			$(nPaging).addClass('pagination').append(
				'<ul>'+
					...
					'<li class="next disabled"><a href="#">Selanjutnya &rarr; </a></li>'+
				'</ul>'
			);
			var els = $('a', nPaging);
