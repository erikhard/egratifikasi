...
<div class="row-fluid sortable">		
				<div class="box span12">
					...
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white comments"></i><span class="break"></span>Laporan Penerimaan</h2>
						<div class="box-icon">
								...
								$no = 1;
								 ...
								 { 
									...
									<tr align='left'>
										...
										<td>".$dttolak['WAKTU_TERIMA_TGL_1']."</td>
										<td>".$dttolak['JNS_GRAT']."</td>										
										<td class='center'>".$status."</td>										
										<td>
											<a class='btn btn-success' href='".base_url()."index.php/terima/edit/".$id."'>
												<i class='halflings-icon white ok'></i>  
											</a> 
											
											<a class='btn btn-info' href='".base_url()."index.php/terima/edit/".$id."'>
												<i class='halflings-icon white edit'></i>  
											</a> 
											<a class='btn btn-danger' href='".base_url()."index.php/terima/hapus/".$id."'>
