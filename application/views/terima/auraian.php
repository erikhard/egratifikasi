...
if ( $is_update != 0 ) {
		foreach ($single_data as $DATA)
		{
			...
			$WAKTU_TERIMA_TGL	= $DATA->WAKTU_TERIMA_TGL;
			$WAKTU_TERIMA_JAM	= $DATA->WAKTU_TERIMA_JAM;
			$WAKTU_TERIMA_HARI	= $DATA->WAKTU_TERIMA_HARI;
	 ...
	 <label class='checkbox'>
			<div class='alert alert-error '>
				<h4 class='alert-heading'>
					<b> 
					<input type='checkbox' id='persetujuan' name='persetujuan' value='option1'>
					Persetujuan 
					</b>
				</h4>
					<p>
						Dengan ini pelapor bersedia untuk menyerahkan obyek 
						penerimaan yang dilaporkan dalam lembar ini kepada 
						Unit Pengendalian Gratifikasi selambat-lambatnya 7 (tujuh) hari kerja 
						terhitung sejak tanggal penetapan obyek penerimaan tersebut menjadi milik Pelindo III / lainnya.
					</p>
			</div>
	</label>
</div>";
