								...
								<hr>
									<fieldset>
												  <div class="control-group">
													...
													<div class="controls">
													  <input class="input-xlarge required" id="emp_nama" name="emp_nama" value="<?php echo $EMP_NAMA; ?>" type="text"  >
												  ...
												  <div class="control-group">
													...
													<div class="controls">
													  <input class="input-xlarge required" id="emp_jab" name="emp_jab" value="<?php echo $EMP_JAB; ?>" type="text" >
													</div>
												  </div>
												   <div class="control-group">
													<label class="control-label">Cabang</label>
													<div class="controls">
													  <input class="input-xlarge required" id="emp_cabang" name="emp_cabang" value="<?php echo $EMP_CABANG; ?>" type="text" >
													</div>
												  </div>
												  <div class="control-group">
													<label class="control-label">No. Induk Pegawai</label>
													<div class="controls">
													  <input class="input-xlarge required" id="emp_nip" name="emp_nip" value="<?php echo $EMP_NIP; ?>" type="text" >
													</div>
												  </div>
												  <div class="control-group">
													<label class="control-label">No. Telp / HP</label>
													<div class="controls">
													  <input class="input-xlarge" id="emp_telp" name="emp_telp" value="<?php echo $EMP_TELP; ?>" type="text" >
													</div>
												  </div>
												  <div class="control-group">
													<label class="control-label">Email</label>
													<div class="controls">
													  <input class="input-xlarge" id="emp_email" name="emp_email" value="<?php echo $EMP_EMAIL; ?>" type="text" >
													</div>
												  </div>
								...
								<hr>
									<fieldset>
												  <div class="control-group">
													...
													<div class="controls">
													  <input class="input-xlarge" id="pem_nama" name="pem_nama" value="<?php echo $PEM_NAMA; ?>" type="text" >
													</div>
												  </div>
												  <div class="control-group">
													<label class="control-label">Unit Kerja/Jabatan</label>
													<div class="controls">
													  <input class="input-xlarge" id="pem_jab" name="pem_jab" value="<?php echo $PEM_JAB; ?>" type="text" >
													</div>
												  </div>
												  <div class="control-group">
													<label class="control-label">Alamat</label>
													<div class="controls">
													  <input class="input-xlarge" id="pem_alamat" name="pem_alamat" value="<?php echo $PEM_ALAMAT; ?>" type="text" >
													</div>
												  </div>
												  <div class="control-group">
													<label class="control-label">Kontak Telp. / HP</label>
													<div class="controls">
													  <input class="input-xlarge" id="pem_telp" name="pem_telp" value="<?php echo $PEM_TELP; ?>" type="text" >
													</div>
												  </div>
												  <div class="control-group">
													<label class="control-label">Email</label>
													<div class="controls">
													  <input class="input-xlarge" id="pem_email" name="pem_email" value="<?php echo $PEM_EMAIL; ?>" type="text" >
													</div>
												  </div>
												  <div class="control-group">
													...
													<div class="controls">
													  <select id="selectError" name="selectError" data-rel="chosen" >
													   ...
													   <input class="input-xlarge" id="hub_pelindo" name="hub_pelindo" value="<?php echo $HUB_PELINDO; ?>" type="text" >
													</div>
												  </div>
									</fieldset>
									...
									<fieldset>
												<div class="control-group">
													...
													<div class="controls">
													  <input class="input-xlarge required" id="tmpt_terima" name="tmpt_terima" value="<?php echo $TMPT_TERIMA; ?>" type="text"  >
													</div>
												  </div>
												  <div class="control-group">
													<label class="control-label" for="focusedInput">Alamat Tempat Penerimaan</label>
													<div class="controls">
													  <input class="input-xlarge required" id="tmpt_terima_alamat" name="tmpt_terima_alamat" value="<?php echo $TMPT_TERIMA_ALAMAT; ?>" type="text"  >
													</div>
												  </div>
												  <div class="control-group">
												  ...
												  <div class="control-group">
													...
													<div class="controls">
													 <input type="text" class="input-xlarge clockpicker" name="waktu_terima_tgl" value="<?php echo $WAKTU_TERIMA_TGL; ?>" id="waktu_terima_tgl" >
													</div>
												  </div>
												  <div class="control-group">
													<label class="control-label">Pukul Waktu Penerimaan</label>
													<div class="controls">
														<input type="text" class="input-xlarge timepicker" name="waktu_terima_jam" id="waktu_terima_jam" value="<?php echo $WAKTU_TERIMA_JAM; ?>">
												  ...
												  <div class="control-group">
													...
													<div class="controls">
														<textarea id="uraian_keg" name="uraian_keg"><?php echo $URAIAN_KEG; ?></textarea>
													</div>
												  </div>
												   <div class="control-group">
													<label class="control-label">Jenis Gratifikasi</label>
													<div class="controls">
													  <input class="input-xlarge required" id="jns_grat" name="jns_grat" value="<?php echo $JNS_GRAT; ?>" type="text" >
													</div>
												  </div>
												  <div class="control-group">
													<label class="control-label">Bentuk Gratifikasi</label>
													<div class="controls">
													  <input class="input-xlarge required" id="bentuk_grat" name="bentuk_grat" value="<?php echo $BENTUK_GRAT; ?>" type="text" >
													</div>
												  </div>
												  <div class="control-group">
													<label class="control-label" for="selectError">Jumlah / Kuantitas</label>
													<div class="controls">
													   <input class="input-xlarge required" id="nilai_grat" name="nilai_grat" value="<?php echo $NILAI_GRAT; ?>" type="text" >
													</div>
												  </div>
